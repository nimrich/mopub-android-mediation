...
public class GooglePlayServicesMediaLayout extends RelativeLayout {
    ...
    // Constructors
    public GooglePlayServicesMediaLayout(@NonNull final Context context) {
        this(context, null);
    }

    public GooglePlayServicesMediaLayout(@NonNull final Context context, @Nullable final AttributeSet attrs) {
